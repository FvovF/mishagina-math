...
export default function About() {
  ...
  return (
    <section id="about" ref={sectionRef} className="py-12 sm:py-16 md:py-20 lg:py-24 bg-white">
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        <div className={`max-w-4xl mx-auto transition-all duration-1000 ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'}`}>
          ...
          {/* Content */}
          <div className="bg-gradient-to-br from-blue-50 to-white rounded-2xl sm:rounded-3xl p-6 sm:p-8 lg:p-12 shadow-xl">
            <div className="space-y-4 sm:space-y-6 text-base sm:text-lg text-gray-700 leading-relaxed">
              <p className="text-xl sm:text-2xl font-semibold text-gray-900 mb-4 sm:mb-8">
              ...
              <div className="grid sm:grid-cols-2 gap-4 sm:gap-6 pt-6 sm:pt-8">
                <div className="flex items-start space-x-3 sm:space-x-4">
                  ...
                  <div>
                    <h3 className="font-semibold text-gray-900 mb-1 text-sm sm:text-base">Чёткий план</h3>
                    <p className="text-gray-600 text-xs sm:text-base">Структурированная программа подготовки</p>
                  </div>
                </div>
                ...
                <div className="flex items-start space-x-3 sm:space-x-4">
                  ...
                  <div>
                    <h3 className="font-semibold text-gray-900 mb-1 text-sm sm:text-base">Личный подход</h3>
                    <p className="text-gray-600 text-xs sm:text-base">Учитываю особенности каждого ученика</p>
                  </div>
                </div>
                ...
                <div className="flex items-start space-x-3 sm:space-x-4">
                  ...
                  <div>
                    <h3 className="font-semibold text-gray-900 mb-1 text-sm sm:text-base">Устранение пробелов</h3>
                    <p className="text-gray-600 text-xs sm:text-base">Работа над слабыми темами</p>
                  </div>
                </div>
                ...
                <div className="flex items-start space-x-3 sm:space-x-4">
                  ...
                  <div>
                    <h3 className="font-semibold text-gray-900 mb-1 text-sm sm:text-base">Видимый прогресс</h3>
                    <p className="text-gray-600 text-xs sm:text-base">Регулярный контроль результатов</p>
                  </div>
                </div>
              </div>
            </div>
