...
export default function Contacts() {
  ...
  return (
    <section id="contacts" ref={sectionRef} className="py-12 sm:py-16 md:py-20 lg:py-24 bg-gradient-to-br from-blue-50 to-white">
        ...
        <div className={`transition-all duration-1000 ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'}`}>
          ...
          <div className="grid sm:grid-cols-3 gap-6 sm:gap-8 max-w-5xl mx-auto">
            ...
            <a
              ...
              className={`bg-white rounded-xl sm:rounded-2xl p-6 sm:p-8 shadow-xl hover:shadow-2xl transition-all duration-500 hover:-translate-y-2 group ${
                isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'
              }`}
            >
              <div className="flex flex-col items-center text-center space-y-3 sm:space-y-4">
                <div className="w-16 h-16 sm:w-20 sm:h-20 bg-blue-600 rounded-xl sm:rounded-2xl flex items-center justify-center group-hover:scale-110 transition-transform duration-300">
                  <svg className="w-8 h-8 sm:w-10 sm:h-10 text-white" fill="currentColor" viewBox="0 0 24 24">
                    <path d="M12 0C5.373 0 0 5.373 0 12s5.373 12 12 12 12-5.373 12-12S18.627 0 12 0zm5.894 8.221l-1.97 9.28c-.145.658-.537.818-1.084.508l-3-2.21-1.446 1.394c-.14.18-.357.295-.6.295-.002 0-.003 0-.005 0l.213-3.054 5.56-5.022c.24-.213-.054-.334-.373-.121l-6.869 4.326-2.96-.924c-.64-.203-.658-.64.135-.954l11.566-4.458c.538-.196 1.006.128.832.941z" />
                  </svg>
                </div>
                <div>
                  <h3 className="text-lg sm:text-xl font-bold text-gray-900 mb-1 sm:mb-2">Telegram</h3>
                  <p className="text-sm sm:text-base text-blue-600 font-semibold mb-1 sm:mb-2 break-all">@OlgaMish_teacher</p>
                  <p className="text-xs sm:text-sm text-gray-600">Быстрые ответы в мессенджере</p>
                </div>
              </div>
            </a>
            ...
            >
              <div className="flex flex-col items-center text-center space-y-3 sm:space-y-4">
                ...
                <div>
                  <h3 className="text-lg sm:text-xl font-bold text-gray-900 mb-1 sm:mb-2">Телефон</h3>
                  <p className="text-sm sm:text-base text-blue-600 font-semibold mb-1 sm:mb-2">+7 (999) 123-45-67</p>
                  <p className="text-xs sm:text-sm text-gray-600">Звоните в любое время</p>
                </div>
              </div>
            </a>
            ...
            >
              <div className="flex flex-col items-center text-center space-y-3 sm:space-y-4">
                ...
                <div>
                  <h3 className="text-lg sm:text-xl font-bold text-gray-900 mb-1 sm:mb-2">ВКонтакте</h3>
                  <p className="text-sm sm:text-base text-blue-600 font-semibold mb-1 sm:mb-2 break-all">olga_math_teacher</p>
                  <p className="text-xs sm:text-sm text-gray-600">Полезные материалы и новости</p>
                </div>
              </div>
            </a>
          </div>
          ...
          <div className="mt-12 sm:mt-16 max-w-4xl mx-auto">
            <div className="bg-gradient-to-r from-blue-600 to-blue-700 rounded-2xl sm:rounded-3xl p-6 sm:p-8 lg:p-12 shadow-2xl text-center text-white">
              ...
              <div className="flex flex-col sm:flex-row gap-3 sm:gap-4 justify-center">
                <a
                  ...
                  target="_blank"
                  rel="noopener noreferrer"
                  className="px-6 sm:px-8 py-3 sm:py-4 bg-white text-blue-600 font-semibold rounded-xl hover:bg-blue-50 transition-all duration-300 hover:shadow-xl hover:-translate-y-1 text-sm sm:text-base"
                >
                  Написать в Telegram
                </a>
                <a
                  href="tel:+79991234567"
                  className="px-6 sm:px-8 py-3 sm:py-4 bg-blue-800 text-white font-semibold rounded-xl hover:bg-blue-900 transition-all duration-300 hover:shadow-xl hover:-translate-y-1 text-sm sm:text-base"
                >
                  Позвонить
                </a>
              </div>
