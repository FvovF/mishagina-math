            ...
            {results.map((result, index) => (
              ...
              >
                <div className="text-center space-y-6">
                  ...
                  {/* Before score */}
                  <div>
                    <div className="text-sm text-gray-500 mb-2">Было</div>
                    <div className="text-3xl font-bold text-red-500">{result.before}</div>
                  ...
                  {/* After score */}
                  <div>
                    <div className="text-sm text-gray-500 mb-2">Стало</div>
                    <div className="text-4xl font-bold text-green-500">{result.after}</div>
                    <div className="text-sm text-gray-600">баллов</div>
                  </div>

                  {/* Improvement */}
                  <div className="pt-4 border-t border-gray-200">
                    <div className="inline-flex items-center space-x-2 bg-green-100 text-green-700 px-4 py-2 rounded-full font-semibold">
